...
init_y_to_block_1:
	ldi YH, high(my_block_1)
	ldi YL, low(my_block_1)
ret

init_y_to_block_2:
	ldi YH, high(my_block_2)
	ldi YL, low(my_block_2)
ret

init_my_block_to_zero:
	st Y+, ZeroReg
	st Y+, ZeroReg
	st Y+, ZeroReg
	st Y+, ZeroReg
...
Main:
	rcall init_y_to_block_1
	rcall init_my_block_to_zero
	
	clr i
	rcall write_my_block
rjmp Main
