...
.def iterator=r16
.equ koncova_podminka=10
.equ koncova_podminka2=15

funkce_prvniho_loopu:
	inc iterator
	cpi iterator, koncova_podminka
	brne for_loop
ret

funkce_druheho_loopu:
	inc iterator
	cpi iterator, koncova_podminka2
	brne for_loop2
ret
...
Main:
	...
	ldi iterator,0
	for_loop:
		rcall funkce_prvniho_loopu
	for_loop2:
		rcall funkce_druheho_loopu		
	rjmp hotovo
